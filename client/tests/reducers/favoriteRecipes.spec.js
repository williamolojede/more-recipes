import reducer from '../../reducers/favoriteRecipes';
import * as types from '../../actions/types';
import recipesMock from '../__mocks__/recipes.mock';

describe('favorite recipes reducer', () => {
  ...
  it('should update the store when favorite recipes are received', () => {
    const { recipes, pagination, errorMessage } = reducer(undefined, {
      type: types.RECEIVE_FAVORITE_RECIPES,
